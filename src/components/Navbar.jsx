        ...
        <header className="navbar" role="banner">
            <div className="navbar__inner container">
                ...
                >
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--space-4)', marginTop: menuOpen ? 'var(--space-4)' : '0' }}>
                        <ThemeSwitch />
                        <a href="#demo" className="btn btn--primary btn--sm navbar__cta" style={{ margin: 0 }}>
                            預約 Demo
                        </a>
                    </div>
                </nav>
